...
""" Leer 8 numeros enteros y cargar un arreglo
con los primeros 6 numeros pares.
Si no hay numeros pares, cargarlos con ceros.
Y si no llegan a ser 6, completar hasta el sexto
